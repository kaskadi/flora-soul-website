[![Sync status](https://img.shields.io/github/workflow/status/kaskadi/static-example/sync?label=sync&logo=github)](https://github.com/kaskadi/static-example/actions?query=workflow%3Async)
